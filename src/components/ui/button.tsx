  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground rounded-pill shadow-[0_0_20px_hsl(var(--bruchat-accent-glow)/0.3)] hover:shadow-[0_0_30px_hsl(var(--bruchat-accent-glow)/0.5)] hover:scale-[1.02] active:scale-[0.98]",
        "hero-outline": "border-2 border-primary text-primary rounded-pill hover:bg-primary hover:text-primary-foreground hover:shadow-[0_0_20px_hsl(var(--bruchat-accent-glow)/0.3)]",
        accent: "bg-primary text-primary-foreground rounded-pill hover:shadow-[0_0_16px_hsl(var(--bruchat-accent-glow)/0.4)]",
        "icon-action": "rounded-full hover:bg-accent hover:text-accent-foreground",
      },
      size: {
